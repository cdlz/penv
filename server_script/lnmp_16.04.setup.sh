...
apt-get update 
apt-get -y install dos2unix screen lrzsz  vim  curl 
...
apt-get -y install php7.0-common php7.0-dev php-apc php7.0-curl  php7.0-gd php7.0-idn php-pear php7.0-memcache php7.0-ming php7.0-recode php7.0-tidy php7.0-xmlrpc php7.0-xsl
...
cat >imzc.net.conf <<EOF

server
  {
    listen       80;
    server_name  imzc.net 127.0.0.1 ;
...
#apt-get update
apt-get install  -y build-essential mysql-client-5.7  libmysqld-dev
